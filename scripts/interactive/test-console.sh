...
echo "  - testdata/index.html (comprehensive test page with console buttons)"
...
heading "Option 1: Use testdata page with console test buttons (Recommended)"
echo "Navigate to testdata page which has built-in console test buttons"
cmd "webctl serve \$(git rev-parse --show-toplevel)/testdata"

echo ""
echo "The test page has buttons to generate console logs:"
echo "  - Log Message button"
echo "  - Warn Message button"
echo "  - Error Message button"
echo "  - Info Message button"
echo ""
echo "Click the buttons to generate console logs, then test console commands"
echo "This provides realistic user-triggered console output"
read -p "Press Enter when you've generated some logs (or skip to Option 2)..."

heading "Option 2: Use example.com with injected logs"
echo "Alternatively, navigate to a simple page and inject logs"
